module param
  implicit none
  integer, parameter :: nat = 48, T0 = 1000  ! nombre de villes/points/...
...
real(8) function temperature_function(istep, nstep)
  ...
  exp_temp   = T0*((0.8)**(istep/1000))  ! exponential multiplicative cooling Kirkpatrick, Gelatt and Vecchi (1983)
  const_temp = T0
